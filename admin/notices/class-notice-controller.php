    ...
    function admin_notices() {
        ...
        if( ! adplugg_is_access_code_installed() ) {
            if( $screen_id != 'toplevel_page_adplugg' ) {
                $notices[] = AdPlugg_Notice::create( 'nag_configure', 'You\'ve activated the AdPlugg Plugin, yay! Now let\'s <a title="Configure the AdPlugg Plugin!" href="' . admin_url('admin.php?page=adplugg') . '">configure</a> it!' );
            }
        } else {
